...
public class TagsActivity extends AppCompatActivity {
    ...
    private TreeMap<Category, ArrayList<Field>> contextsAndAttributes;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contextsAndAttributes =
                new TreeMap<>((HashMap<Category, ArrayList<Field>>) azureDB.get("azure"));
        ...
        for (Map.Entry<Category, ArrayList<Field>> entry : contextsAndAttributes.entrySet()) {
        ...
        cancelBtn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent i = new Intent(TagsActivity.this, MainActivity.class);
    ...
    public void showForm(Category choice) {
        ...
        ArrayList<Field> attList = new ArrayList<Field>(contextsAndAttributes.get(choice));
